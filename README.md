...
歌詞から原音設定のエイリアスを探すときは、直前の母音を付けた形を先に試し、続いて歌詞そのもの、ひらがな、カタカナ、モーラ、モーラのカタカナ、ローマ字の順に試します。それぞれについて、声色と音域に合う接頭辞と接尾辞、`prefix.map` の接頭辞と接尾辞、接頭辞と接尾辞なしの順に照合します。
...
- 原音設定に見つからなかった歌詞があるときは、工具列の右端に警告として並びます。ノートエディターを開いたときの内容を表示します。
