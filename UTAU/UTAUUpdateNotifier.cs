...
internal static class UTAUUpdateNotifier
{
    private const string Owner = "routersys";
    private const string Repository = "YMM4-UTAU";
    ...
    private static async Task RunAsync()
    {
        try
        {
            ...
            {
                CurrentVersion = PluginVersion.FromAssemblyInformationalVersion(typeof(UTAUUpdateNotifier)),
    ...
    private static Task ShowNotificationAsync(UpdateNotification notification, CancellationToken cancellationToken)
    {
        ...
        return application.Dispatcher.InvokeAsync(() =>
            MessageBox.Show(notification.Message, Texts.UTAU, MessageBoxButton.OK, MessageBoxImage.Information)).Task;
    }
}
